...
function Lightnavbar() {
    return (
        ...
        <nav className="navbar navbar-main navbar-expand-lg navbar-dark bg-dark" id="navbar-main">
          <div className="container"><a className="navbar-brand" href="\"><img alt="Logo" src="https://i.imgur.com/wSnqo7B.png" id="navbar-logo" /> </a><button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-main-collapse" aria-controls="navbar-main-collapse" aria-expanded="false" aria-label="Toggle navigation"><span className="navbar-toggler-icon" /></button>
            <div className="collapse navbar-collapse navbar-collapse-overlay" id="navbar-main-collapse">
              ...
              <ul className="navbar-nav ml-lg-auto">
                ...
                <li className="nav-item nav-item-spaced dropdown dropdown-animate" data-toggle="hover"><a className="nav-link" data-toggle="dropdown" href="!#" aria-expanded="false">Our Services</a>
                        ...
                        <div className="dropdown-body dropdown-body-right bg-dropdown-secondary h-100">
                          <div className="list-group list-group-flush">
                            <div className="list-group-item border-0">
                              <div className="media d-flex">
                                <figure style={{width: '40px'}}>
                                  <img alt="Users" src="assets/img/svg/icons/User_male.svg" className="img-fluid" style={{height: '40px'}} />
                                </figure>
                            ...
                            <div className="list-group-item border-0">
                              <div className="media d-flex">
                                <figure style={{width: '40px'}}>
                                  <img alt="Enterprise" src="assets/img/svg/icons/Enterprise_2.svg" className="img-fluid" style={{height: '40px'}} />
                                </figure>
                                <div className="media-body ml-3">
                        ...
                        <div className="dropdown-body">
                          <div className="list-group list-group-flush">
                            ...
                            <div className="list-group-item border-0">
                              <div className="media d-flex align-items-center">
                                <figure style={{width: '40px'}}>
                                  <img alt="Shopping Bag" src="assets/img/svg/icons/Shopping_Bag.svg" className="img-fluid" style={{width: '40px'}} />
                                </figure>
                                <div className="media-body ml-3">
                ...
                <li className="nav-item nav-item-spaced dropdown dropdown-animate" data-toggle="hover"><a className="nav-link" href="!#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Company</a>
                ...
                <li className="nav-item nav-item-spaced dropdown dropdown-animate" data-toggle="hover"><a className="nav-link" href="!#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Support</a>
                  <div className="dropdown-menu dropdown-menu-md p-0">
                    <ul className="list-group list-group-flush px-lg-4">
                ...
                <li className="nav-item nav-item-spaced d-none d-lg-block">
                  <a className="nav-link" href="https://blog.iverify.ng" target="_blank" rel="noreferrer">Blog</a>
                </li>
              </ul>

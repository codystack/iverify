                    ...
                    <div className="container">
                        <div className="row py-6">
                            <div className="text-center">
                                ...
                                <a href="auth/signup" target="_blank" className="btn btn-lg btn-warning text-dark btn-icon mb-3 mb-lg-0">
                                    <span className="btn-inner--text">Join the tribe</span>
                                    <span className="btn-inner--icon"><i data-feather="arrow-right" /></span>
                                </a>
                            </div>
                        </div>
                    </div>

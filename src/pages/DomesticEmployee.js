            ...
            <section className="slice py-5">
                <div className="container">
                    ...
                    <div className="col-12 col-md-5 col-lg-6 order-md-2">
                        <figure className="w-100"><img alt="Domestic Employee" src="./assets/img/svg/domesticem.gif" className="img-fluid mw-md-120" /></figure>
                    </div>
                    <div className="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                        <h1 className="display-4 text-center text-md-left mb-3">Domestic Employee <strong className="text-primary">Verification</strong></h1>
...
export default DomesticEmployee
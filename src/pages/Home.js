                ...
                <div className="container text-center text-lg-left">
                    <div className="row mb-6 justify-content-center text-center">
                        <div className="col-lg-8 col-md-10"><span className="badge badge-primary badge-pill">What we offer</span>
                            <h3 className="mt-4">A one stop shop for your <span className="text-warning typed" id="type-example-1" data-type-this="identity, company, certificate, employee, tenant, property"></span> verification.
                            </h3>
                        </div>
                    </div>
